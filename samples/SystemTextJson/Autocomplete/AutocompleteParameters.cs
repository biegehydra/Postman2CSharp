...
namespace SystemTextJson
{
    public class AutocompleteParameters : IQueryParameters
    {
        ...
        /// <summary>
        /// The point around which to retrieve place information. This must be specified as `latitude,longitude`. >When using the Text Search API, the `location` parameter may be overriden if the `query` contains an explicit location such as `Market in Barcelona`.
        /// 
        /// </summary>
