...
namespace SystemTextJson
{
    ...
    public class FindPlaceFromTextParameters : IQueryParameters
    {
        ...
        /// errors
        /// and are not guaranteed to return valid results. The Places API will return candidate matches 
        ...
        /// must be in international format (prefixed by a plus sign ("+"), followed by the country code, then 
        /// the phone number itself). See [E.164 ITU recommendation](https://en.wikipedia.org/wiki/E.164) for 
        /// more information.
        ///  
        /// </summary>
        ...
        /// biasing by default.
        /// - IP bias: Instructs the API to use IP address biasing. Pass the string `ipbias` 
        /// (this option has no additional parameters).
        /// - Point: A single lat/lng coordinate. Use the following 
        ...
        /// - Rectangular: A string specifying two 
        /// lat/lng pairs in decimal degrees, representing the south/west and north/east points of a rectangle. 
        /// Use the following format:`rectangle:south,west|north,east`. Note that east/west values are wrapped 
        /// to the range -180, 180, and north/south values are clamped to the range -90, 90.
        ///  
        /// </summary>
