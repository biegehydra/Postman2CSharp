...
namespace GooglePlace
{
    ...
    public class TextSearchParameters : IQueryParameters
    {
        ...
        /// >The location parameter may be overriden if the query contains an explicit location such as Market in 
        /// Barcelona. Using quotes around the query may also influence the weight given to the location and radius
        /// </summary>
        ...
        /// of input can generate errors and are not guaranteed to return valid results. The Google Places service 
