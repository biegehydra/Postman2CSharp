...
// Root myDeserializedClass = JsonSerializer.Deserialize<TyeventsforaclientwithinanetworkinthetimespanParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class TyeventsforaclientwithinanetworkinthetimespanParameters : IQueryParameters
    {
        /// <summary>
