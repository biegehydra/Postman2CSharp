...
// Root myDeserializedClass = JsonSerializer.Deserialize<AtedLatencyInfoForThisNetworkGroupedByClientsParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class AtedLatencyInfoForThisNetworkGroupedByClientsParameters : IQueryParameters
    {
        /// <summary>
