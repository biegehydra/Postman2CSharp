...
// Root myDeserializedClass = JsonSerializer.Deserialize<List<SMNetworkWithVariousSpecifiedFieldsAndFilters2Response>>(myJsonResponse);
namespace MerakiDashboard
{
    public class SMNetworkWithVariousSpecifiedFieldsAndFilters2Response
    {
