...
// Root myDeserializedClass = JsonSerializer.Deserialize<UpdateTheAttributesOfAnMRSSIDResponse>(myJsonResponse);
namespace MerakiDashboard
{
    public class UpdateTheAttributesOfAnMRSSIDResponse
    {
