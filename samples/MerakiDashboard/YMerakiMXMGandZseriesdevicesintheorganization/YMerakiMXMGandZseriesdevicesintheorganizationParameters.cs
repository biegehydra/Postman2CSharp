...
// Root myDeserializedClass = JsonSerializer.Deserialize<YMerakiMXMGandZseriesdevicesintheorganizationParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class YMerakiMXMGandZseriesdevicesintheorganizationParameters : IQueryParameters
    {
        /// <summary>
