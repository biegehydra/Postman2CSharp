...
// Root myDeserializedClass = JsonSerializer.Deserialize<MerakiMXAndZSeriesAppliancesInTheOrganizationParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class MerakiMXAndZSeriesAppliancesInTheOrganizationParameters : IQueryParameters
    {
        /// <summary>
