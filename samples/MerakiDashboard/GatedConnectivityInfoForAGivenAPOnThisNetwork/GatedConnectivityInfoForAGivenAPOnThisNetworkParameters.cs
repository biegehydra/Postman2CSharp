...
// Root myDeserializedClass = JsonSerializer.Deserialize<GatedConnectivityInfoForAGivenAPOnThisNetworkParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class GatedConnectivityInfoForAGivenAPOnThisNetworkParameters : IQueryParameters
    {
        /// <summary>
