...
// Root myDeserializedClass = JsonSerializer.Deserialize<CreateAnAccessPolicyForASwitchNetworkResponse>(myJsonResponse);
namespace MerakiDashboard
{
    public class CreateAnAccessPolicyForASwitchNetworkResponse
    {
