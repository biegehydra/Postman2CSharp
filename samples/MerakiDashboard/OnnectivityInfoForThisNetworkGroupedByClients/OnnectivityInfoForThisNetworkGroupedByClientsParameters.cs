...
// Root myDeserializedClass = JsonSerializer.Deserialize<OnnectivityInfoForThisNetworkGroupedByClientsParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class OnnectivityInfoForThisNetworkGroupedByClientsParameters : IQueryParameters
    {
        /// <summary>
