...
// Root myDeserializedClass = JsonSerializer.Deserialize<EgatedLatencyInfoForAGivenClientOnThisNetworkParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class EgatedLatencyInfoForAGivenClientOnThisNetworkParameters : IQueryParameters
    {
        /// <summary>
