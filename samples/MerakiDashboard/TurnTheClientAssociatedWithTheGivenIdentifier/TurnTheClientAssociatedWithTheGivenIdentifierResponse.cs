...
// Root myDeserializedClass = JsonSerializer.Deserialize<TurnTheClientAssociatedWithTheGivenIdentifierResponse>(myJsonResponse);
namespace MerakiDashboard
{
    public class TurnTheClientAssociatedWithTheGivenIdentifierResponse
    {
