...
// Root myDeserializedClass = JsonSerializer.Deserialize<RetrieveASingleQualityRetentionProfileResponse>(myJsonResponse);
namespace MerakiDashboard
{
    public class RetrieveASingleQualityRetentionProfileResponse
    {
