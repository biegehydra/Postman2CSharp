...
// Root myDeserializedClass = JsonSerializer.Deserialize<ErstatusinformationfordevicesinanorganizationParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class ErstatusinformationfordevicesinanorganizationParameters : IQueryParameters
    {
        /// <summary>
