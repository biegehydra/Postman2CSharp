...
// Root myDeserializedClass = JsonSerializer.Deserialize<HeClientsThatHaveUsedThisNetworkInTheTimespanResponse>(myJsonResponse);
namespace MerakiDashboard
{
    public class HeClientsThatHaveUsedThisNetworkInTheTimespanResponse
    {
