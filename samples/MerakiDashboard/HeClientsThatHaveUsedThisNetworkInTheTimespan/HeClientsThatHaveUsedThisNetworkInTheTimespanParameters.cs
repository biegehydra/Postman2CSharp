...
// Root myDeserializedClass = JsonSerializer.Deserialize<HeClientsThatHaveUsedThisNetworkInTheTimespanParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class HeClientsThatHaveUsedThisNetworkInTheTimespanParameters : IQueryParameters
    {
        /// <summary>
