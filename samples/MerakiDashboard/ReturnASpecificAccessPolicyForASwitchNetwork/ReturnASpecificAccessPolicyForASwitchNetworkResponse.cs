...
// Root myDeserializedClass = JsonSerializer.Deserialize<ReturnASpecificAccessPolicyForASwitchNetworkResponse>(myJsonResponse);
namespace MerakiDashboard
{
    public class ReturnASpecificAccessPolicyForASwitchNetworkResponse
    {
