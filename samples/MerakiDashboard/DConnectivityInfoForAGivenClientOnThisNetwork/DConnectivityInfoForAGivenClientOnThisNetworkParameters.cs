...
// Root myDeserializedClass = JsonSerializer.Deserialize<DConnectivityInfoForAGivenClientOnThisNetworkParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class DConnectivityInfoForAGivenClientOnThisNetworkParameters : IQueryParameters
    {
        /// <summary>
