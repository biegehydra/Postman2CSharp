...
// Root myDeserializedClass = JsonSerializer.Deserialize<EatesNewQualityRetentionProfileForThisNetworkResponse>(myJsonResponse);
namespace MerakiDashboard
{
    public class EatesNewQualityRetentionProfileForThisNetworkResponse
    {
