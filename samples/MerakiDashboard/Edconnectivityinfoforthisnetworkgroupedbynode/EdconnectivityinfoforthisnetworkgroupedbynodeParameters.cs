...
// Root myDeserializedClass = JsonSerializer.Deserialize<EdConnectivityInfoForThisNetworkGroupedByNodeParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class EdConnectivityInfoForThisNetworkGroupedByNodeParameters : IQueryParameters
    {
        /// <summary>
