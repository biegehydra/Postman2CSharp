...
// Root myDeserializedClass = JsonSerializer.Deserialize<AggregatedLatencyInfoForAGivenAPOnThisNetworkParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class AggregatedLatencyInfoForAGivenAPOnThisNetworkParameters : IQueryParameters
    {
        /// <summary>
