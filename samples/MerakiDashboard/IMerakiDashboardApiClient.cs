...
namespace MerakiDashboard
{
    public interface IMerakiDashboardApiClient
    {
        ...
        Task<AddAStaticDelegatedPrefixFromANetworkResponse> AddAStaticDelegatedPrefixFromANetwork(AddAStaticDelegatedPrefixFromANetworkRequest request, string networkId);
        ...
        Task<EsAtTheSpecifiedTimeAndReturnALinkToThatImageResponse> EsAtTheSpecifiedTimeAndReturnALinkToThatImage(EsAtTheSpecifiedTimeAndReturnALinkToThatImageRequest request, string serial);
        ...
        Task<EmptyResponse> AnExistingCameraWirelessProfileForThisNetwork(string networkId, string wirelessProfileId);
        ...
        Task<EmptyResponse> ExistingQualityRetentionProfileForThisNetwork2(string networkId, string qualityRetentionProfileId);
        ...
        Task<CreateALayer3InterfaceForASwitchResponse> CreateALayer3InterfaceForASwitch(CreateALayer3InterfaceForASwitchRequest request, string serial);
        ...
        Task<CreateALayer3StaticRouteForASwitchResponse> CreateALayer3StaticRouteForASwitch(CreateALayer3StaticRouteForASwitchRequest request, string serial);
        ...
        Task<CreateAnAccessPolicyForASwitchNetworkResponse> CreateAnAccessPolicyForASwitchNetwork(CreateAnAccessPolicyForASwitchNetworkRequest request, string networkId);
        ...
        Task<CreateALinkAggregationGroupResponse> CreateALinkAggregationGroup(CreateALinkAggregationGroupRequest request, string networkId);
        ...
        Task<AddASwitchPortScheduleResponse> AddASwitchPortSchedule(AddASwitchPortScheduleRequest request, string networkId);
        ...
        Task<AddAQualityOfServiceRuleResponse> AddAQualityOfServiceRule(AddAQualityOfServiceRuleRequest request, string networkId);
        ...
        Task<CreateAStackResponse> CreateAStack(CreateAStackRequest request, string networkId);
        ...
        Task<CreatesNewRFProfileForThisNetworkResponse> CreatesNewRFProfileForThisNetwork(CreatesNewRFProfileForThisNetworkRequest request, string networkId);
        ...
        Task<CreatesNewRFProfileForThisNetwork2Response> CreatesNewRFProfileForThisNetwork2(CreatesNewRFProfileForThisNetwork2Request request, string networkId);
        ...
        Task<DAMediaServerToBeMonitoredForThisOrganizationResponse> DAMediaServerToBeMonitoredForThisOrganization(DAMediaServerToBeMonitoredForThisOrganizationRequest request, string organizationId);
        ...
        Task<EmptyResponse> LeteAMonitoredMediaServerFromThisOrganization(string organizationId, string monitoredMediaServerId);
        ...
        Task<AddATargetGroupResponse> AddATargetGroup(AddATargetGroupRequest request, string networkId);
        ...
        Task<RebootADeviceResponse> RebootADevice(string serial);
        ...
        Task<OrganizationByCloningTheAddressedOrganizationResponse> OrganizationByCloningTheAddressedOrganization(OrganizationByCloningTheAddressedOrganizationRequest request, string organizationId);
