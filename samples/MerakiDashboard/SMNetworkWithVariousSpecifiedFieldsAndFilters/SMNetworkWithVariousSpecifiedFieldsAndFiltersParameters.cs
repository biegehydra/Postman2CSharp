...
// Root myDeserializedClass = JsonSerializer.Deserialize<SMNetworkWithVariousSpecifiedFieldsAndFiltersParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class SMNetworkWithVariousSpecifiedFieldsAndFiltersParameters : IQueryParameters
    {
        /// <summary>
