...
// Root myDeserializedClass = JsonSerializer.Deserialize<ListTheSecurityEventsForANetworkParameters>(myJsonResponse);
namespace MerakiDashboard
{
    public class ListTheSecurityEventsForANetworkParameters : IQueryParameters
    {
        /// <summary>
