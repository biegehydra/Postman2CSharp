...
// Root myDeserializedClass = JsonSerializer.Deserialize<ListTheBluetoothClientsSeenByAPsInThisNetworkParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class ListTheBluetoothClientsSeenByAPsInThisNetworkParameters : IQueryParameters
    {
        /// <summary>
        ...
        /// parameter t0. The value must be in seconds and be less than or equal to 7 days. The default is 1 
        /// day. 
        /// </summary>
