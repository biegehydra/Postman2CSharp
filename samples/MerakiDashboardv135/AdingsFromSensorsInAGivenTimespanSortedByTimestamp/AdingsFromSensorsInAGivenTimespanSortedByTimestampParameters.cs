...
// Root myDeserializedClass = JsonSerializer.Deserialize<AdingsFromSensorsInAGivenTimespanSortedByTimestampParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class AdingsFromSensorsInAGivenTimespanSortedByTimestampParameters : IQueryParameters
    {
        /// <summary>
        ...
        /// <summary>
        /// The beginning of the timespan for the data. The maximum lookback period is 365 days and 6 hours from 
        /// today. 
        /// </summary>
