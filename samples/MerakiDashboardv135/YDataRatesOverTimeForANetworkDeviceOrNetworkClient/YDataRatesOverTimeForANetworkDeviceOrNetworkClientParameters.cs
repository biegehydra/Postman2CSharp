...
// Root myDeserializedClass = JsonSerializer.Deserialize<YDataRatesOverTimeForANetworkDeviceOrNetworkClientParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class YDataRatesOverTimeForANetworkDeviceOrNetworkClientParameters : IQueryParameters
    {
        /// <summary>
