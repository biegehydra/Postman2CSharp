...
// Root myDeserializedClass = JsonSerializer.Deserialize<EgatedConnectivityInfoForAGivenClientOnThisNetworkParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class EgatedConnectivityInfoForAGivenClientOnThisNetworkParameters : IQueryParameters
    {
        /// <summary>
