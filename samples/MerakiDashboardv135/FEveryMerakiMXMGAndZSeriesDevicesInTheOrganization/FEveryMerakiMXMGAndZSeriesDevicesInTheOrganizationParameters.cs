...
{
    // Root myDeserializedClass = JsonSerializer.Deserialize<FEveryMerakiMXMGAndZSeriesDevicesInTheOrganizationParameters>(myJsonResponse);
    public class FEveryMerakiMXMGAndZSeriesDevicesInTheOrganizationParameters : IQueryParameters
    {
        /// <summary>
