...
// Root myDeserializedClass = JsonSerializer.Deserialize<GeChannelUtilizationForAllBandsInANetworkSplitByAPParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class GeChannelUtilizationForAllBandsInANetworkSplitByAPParameters : IQueryParameters
    {
        /// <summary>
        ...
        /// parameters t0 and t1. The value must be in seconds and be less than or equal to 90 days. The default 
        /// is 7 days. 
        /// </summary>
