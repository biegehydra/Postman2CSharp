...
namespace MerakiDashboardv135
{
    ...
    {
        /// <summary>
        /// An optional parameter that is the ID of a config template. Will return all networks bound to that 
        /// template. 
        /// </summary>
        public string ConfigTemplateId { get; set; }
        
        /// <summary>
        /// An optional parameter to filter networks by tags. The filtering is case-sensitive. If tags are 
        /// included, 'tagsFilterType' should also be included (see below). 
        /// </summary>
        public string Tags { get; set; }
        
        /// <summary>
        /// An optional parameter of value 'withAnyTags' or 'withAllTags' to indicate whether to return networks 
