...
{
    // Root myDeserializedClass = JsonSerializer.Deserialize<TusOfEveryMerakiMGCellularGatewayInTheOrganizationParameters>(myJsonResponse);
    public class TusOfEveryMerakiMGCellularGatewayInTheOrganizationParameters : IQueryParameters
    {
        /// <summary>
