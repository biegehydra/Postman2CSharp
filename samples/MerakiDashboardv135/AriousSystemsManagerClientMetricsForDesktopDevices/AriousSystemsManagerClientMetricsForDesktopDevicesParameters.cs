...
// Root myDeserializedClass = JsonSerializer.Deserialize<AriousSystemsManagerClientMetricsForDesktopDevicesParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class AriousSystemsManagerClientMetricsForDesktopDevicesParameters : IQueryParameters
    {
        /// <summary>
