...
// Root myDeserializedClass = JsonSerializer.Deserialize<V4ServersSeenWithinTheSelectedTimeframeDefault1DayParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class V4ServersSeenWithinTheSelectedTimeframeDefault1DayParameters : IQueryParameters
    {
        /// <summary>
