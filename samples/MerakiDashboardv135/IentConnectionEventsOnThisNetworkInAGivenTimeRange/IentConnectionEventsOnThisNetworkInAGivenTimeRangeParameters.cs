...
// Root myDeserializedClass = JsonSerializer.Deserialize<IentConnectionEventsOnThisNetworkInAGivenTimeRangeParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class IentConnectionEventsOnThisNetworkInAGivenTimeRangeParameters : IQueryParameters
    {
        /// <summary>
