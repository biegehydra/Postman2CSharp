...
// Root myDeserializedClass = JsonSerializer.Deserialize<DataWhetherADeviceIsRegularlyCheckingInToDashboardParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class DataWhetherADeviceIsRegularlyCheckingInToDashboardParameters : IQueryParameters
    {
        /// <summary>
