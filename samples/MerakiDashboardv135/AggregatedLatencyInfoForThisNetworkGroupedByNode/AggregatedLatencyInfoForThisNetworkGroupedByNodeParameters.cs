...
{
    // Root myDeserializedClass = JsonSerializer.Deserialize<AggregatedLatencyInfoForThisNetworkGroupedByNodeParameters>(myJsonResponse);
    public class AggregatedLatencyInfoForThisNetworkGroupedByNodeParameters : IQueryParameters
    {
        /// <summary>
