...
{
    // Root myDeserializedClass = JsonSerializer.Deserialize<ChannelUtilizationOverEachRadioForAllAPsInANetworkParameters>(myJsonResponse);
    public class ChannelUtilizationOverEachRadioForAllAPsInANetworkParameters : IQueryParameters
    {
        /// <summary>
        ...
        /// <summary>
        /// The time resolution in seconds for returned data. The valid resolutions are: 600. The default is 
        /// 600. 
        /// </summary>
