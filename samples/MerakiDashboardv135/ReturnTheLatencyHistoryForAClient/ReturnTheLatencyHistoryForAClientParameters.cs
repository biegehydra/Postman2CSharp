...
namespace MerakiDashboardv135
{
    public class ReturnTheLatencyHistoryForAClientParameters : IQueryParameters
    {
        ...
        /// parameters t0 and t1. The value must be in seconds and be less than or equal to 791 days. The 
        /// default is 1 day. 
        /// </summary>
        public string Timespan { get; set; }
        
        /// <summary>
        /// The time resolution in seconds for returned data. The valid resolutions are: 86400. The default is 
        /// 86400. 
        /// </summary>
