...
// Root myDeserializedClass = JsonSerializer.Deserialize<AggregatedLatencyInfoForAGivenClientOnThisNetworkParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class AggregatedLatencyInfoForAGivenClientOnThisNetworkParameters : IQueryParameters
    {
        /// <summary>
