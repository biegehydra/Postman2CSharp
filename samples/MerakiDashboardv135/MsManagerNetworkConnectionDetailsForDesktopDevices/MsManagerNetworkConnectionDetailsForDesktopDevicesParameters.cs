...
{
    // Root myDeserializedClass = JsonSerializer.Deserialize<MsManagerNetworkConnectionDetailsForDesktopDevicesParameters>(myJsonResponse);
    public class MsManagerNetworkConnectionDetailsForDesktopDevicesParameters : IQueryParameters
    {
        /// <summary>
