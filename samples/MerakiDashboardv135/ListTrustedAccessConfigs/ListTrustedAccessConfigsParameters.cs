...
{
    // Root myDeserializedClass = JsonSerializer.Deserialize<ListTrustedAccessConfigsParameters>(myJsonResponse);
    public class ListTrustedAccessConfigsParameters : IQueryParameters
    {
        /// <summary>
