...
// Root myDeserializedClass = JsonSerializer.Deserialize<RegatedConnectivityInfoForThisNetworkGroupedByNodeParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class RegatedConnectivityInfoForThisNetworkGroupedByNodeParameters : IQueryParameters
    {
        /// <summary>
