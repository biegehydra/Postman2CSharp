...
// Root myDeserializedClass = JsonSerializer.Deserialize<ListWirelessMeshStatusesForRepeatersParameters>(myJsonResponse);
namespace MerakiDashboardv135
{
    public class ListWirelessMeshStatusesForRepeatersParameters : IQueryParameters
    {
        /// <summary>
