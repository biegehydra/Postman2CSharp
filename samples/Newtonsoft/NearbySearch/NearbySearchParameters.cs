...
namespace Newtonsoft
{
    ...
    {
        /// <summary>
        /// The text string on which to search, for example: "restaurant" or "123 Main Street". This must be a 
        /// place name, address, or category of establishments.
        /// Any other types of input can generate errors and 
        /// are not guaranteed to return valid results. The Google Places service will return candidate 
        /// matches
        /// based on this string and order the results based on their perceived relevance.
        /// 
        /// Explicitly 
        /// including location information using this parameter may conflict with the location, radius, and 
        /// rankby parameters, causing unexpected results.
        /// 
        /// If this parameter is omitted, places with a 
        ...
        /// - `prominence` (default). This 
        /// option sorts results based on their importance. Ranking will favor prominent places within the set 
        /// radius over nearby places that match but that are less prominent. Prominence can be affected by a 
        /// place's ranking in Google's index, global popularity, and other factors. When prominence is 
        /// specified, the `radius` parameter is required.
        /// - `distance`. This option biases search results in 
        /// ascending order by their distance from the specified location. When `distance` is specified, one or 
